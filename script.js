...
function buildTrenchDefenseViz() {
    ...
    ln([[49.68, 37.30], [49.685, 37.28]], GRN, 2, '4 2'); // Traverse
    ln([[49.675, 37.32], [49.68, 37.30]], GRN, 2); // Main to traverse
    ln([[49.67, 37.34], [49.675, 37.32]], GRN, 2); // Position to main
    ln([[49.665, 37.36], [49.67, 37.34]], GRN, 2); // Position to main
    ln([[49.66, 37.38], [49.665, 37.36]], GRN, 2); // Position to main
    ln([[49.655, 37.40], [49.66, 37.38]], GRN, 2); // Position to main
    ...
    mk(49.677, 37.305, `<rect x="8" y="12" width="34" height="26" fill="${BRN}66" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="19" x2="42" y2="19" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="31" x2="42" y2="31" stroke="${BRN}" stroke-width="2"/><circle cx="15" cy="15" r="2" fill="${BRN}"/><circle cx="15" cy="35" r="2" fill="${BRN}"/>`, 'Стр. №1', '2 стрільці\nАК-74 + ПК\n(змінюються)', [70,70]);
    mk(49.672, 37.325, `<rect x="8" y="12" width="34" height="26" fill="${BRN}66" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="19" x2="42" y2="19" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="31" x2="42" y2="31" stroke="${BRN}" stroke-width="2"/><circle cx="15" cy="15" r="2" fill="${BRN}"/><circle cx="15" cy="35" r="2" fill="${BRN}"/>`, 'Стр. №2', '2 стрільці\nАК-74\n(змінюються)', [70,70]);
    mk(49.667, 37.345, `<rect x="8" y="12" width="34" height="26" fill="${BRN}66" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="19" x2="42" y2="19" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="31" x2="42" y2="31" stroke="${BRN}" stroke-width="2"/><circle cx="15" cy="15" r="2" fill="${BRN}"/><circle cx="15" cy="35" r="2" fill="${BRN}"/>`, 'Стр. №3', '2 стрільці\nРПГ-7 + АК-74\n(змінюються)', [70,70]);
    mk(49.662, 37.365, `<rect x="8" y="12" width="34" height="26" fill="${BRN}66" stroke="${BRN}" stroke-width="2"/><line x1="8" y="19" x2="42" y2="19" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="31" x2="42" y2="31" stroke="${BRN}" stroke-width="2"/><circle cx="15" cy="15" r="2" fill="${BRN}"/><circle cx="15" cy="35" r="2" fill="${BRN}"/>`, 'Стр. №4', '2 стрільці\nСВД + АК-74\n(змінюються)', [70,70]);
    mk(49.657, 37.385, `<rect x="8" y="12" width="34" height="26" fill="${BRN}66" stroke="${BRN}" stroke-width="2"/><line x1="8" y="19" x2="42" y2="19" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="31" x2="42" y2="31" stroke="${BRN}" stroke-width="2"/><circle cx="15" cy="15" r="2" fill="${BRN}"/><circle cx="15" cy="35" r="2" fill="${BRN}"/>`, 'Стр. №5', '2 стрільці\nАК-74\n(змінюються)', [70,70]);
    mk(49.652, 37.405, `<rect x="8" y="12" width="34" height="26" fill="${BRN}66" stroke="${BRN}" stroke-width="2"/><line x1="8" y="19" x2="42" y2="19" stroke="${BRN}" stroke-width="2"/><line x1="8" y1="31" x2="42" y2="31" stroke="${BRN}" stroke-width="2"/><circle cx="15" cy="15" r="2" fill="${BRN}"/><circle cx="15" cy="35" r="2" fill="${BRN}"/>`, 'Стр. №6', 'Командир + стр.\nАК-74 + радіо\n(змінюються)', [70,70]);

    // ---- BUNKERS AND FORTIFIED POSITIONS ----
    zoneLabel(49.62, 37.30, 'БЛІНДАЖІ ТА УКРІПЛЕНІ ПОЗИЦІЇ', YEL, 10);

    // Reinforced bunker
    mk(49.665, 37.355, `<rect x="5" y="10" width="40" height="30" fill="${YEL}33" stroke="${YEL}" stroke-width="3"/><line x1="5" y1="25" x2="45" y2="25" stroke="${YEL}" stroke-width="2"/><line x1="15" y1="10" x2="15" y2="40" stroke="${YEL}" stroke-width="2"/><line x1="35" y1="10" x2="35" y2="40" stroke="${YEL}" stroke-width="2"/>`, 'БЛІНДАЖ-1', 'ДОТ для ПК\nбетон + дерево', [80,80]);

    // Machine gun position
    mk(49.655, 37.395, `<rect x="8" y="12" width="34" height="26" fill="${YEL}33" stroke="${YEL}" stroke-width="2"/><circle cx="25" cy="25" r="8" fill="none" stroke="${YEL}" stroke-width="2"/><line x1="17" y1="17" x2="33" y2="33" stroke="${YEL}" stroke-width="1"/><line x1="33" y1="17" x2="17" y2="33" stroke="${YEL}" stroke-width="1"/>`, 'ПК ПОЗИЦІЯ', 'НСВ «Утьос»\nна сошці', [70,70]);

    // ---- ANTI-TANK POSITIONS ----
    zoneLabel(49.60, 37.20, 'ПРОТИТАНКОВІ ПОЗИЦІЇ', RED, 10);

    // ATGM positions (hidden in trenches)
    mk(49.66, 37.375, `<rect x="10" y="15" width="30" height="20" fill="${RED}33" stroke="${RED}" stroke-width="2"/><polygon points="25,10 20,20 30,20" fill="${RED}"/><line x1="25" y1="20" x2="25" y2="35" stroke="${RED}" stroke-width="2"/>`, 'ПТРК-1', 'Stugna-P\nв окопі', [70,70]);
    mk(49.65, 37.405, `<rect x="10" y="15" width="30" height="20" fill="${RED}33" stroke="${RED}" stroke-width="2"/><polygon points="25,10 20,20 30,20" fill="${RED}"/><line x1="25" y1="20" x2="25" y2="35" stroke="${RED}" stroke-width="2"/>`, 'ПТРК-2', 'Javelin\nпозиція', [70,70]);

    // Tank defensive position
    mk(49.64, 37.385, `<ellipse cx="25" cy="30" rx="15" ry="8" fill="${RED}33" stroke="${RED}" stroke-width="2"/><rect x="18" y="15" width="14" height="10" fill="none" stroke="${RED}" stroke-width="2"/><line x1="25" y1="10" x2="25" y2="15" stroke="${RED}" stroke-width="2"/>`, 'ТАНКОВА ПОЗИЦІЯ', 'Т-72 в окопі\nамбразура', [80,80]);
    ...
    mk(49.658, 37.275, `<rect x="10" y="15" width="30" height="20" fill="${PUR}33" stroke="${PUR}" stroke-width="2"/><line x1="10" y1="25" x2="40" y2="25" stroke="${PUR}" stroke-width="2"/>`, '2-й ЕШЕЛОН-1', 'Резервна позиція', [60,60]);
    mk(49.648, 37.305, `<rect x="10" y="15" width="30" height="20" fill="${PUR}33" stroke="${PUR}" stroke-width="2"/><line x1="10" y1="25" x2="40" y2="25" stroke="${PUR}" stroke-width="2"/>`, '2-й ЕШЕЛОН-2', 'Резервна позиція', [60,60]);

    // ---- OBSERVATION AND COMMAND ----
    zoneLabel(49.75, 37.30, 'СПОСТЕРЕЖЕННЯ ТА УПРАВЛІННЯ', CYN, 10);

    // Observation post
    mk(49.67, 37.325, `<circle cx="25" cy="25" r="15" fill="${CYN}33" stroke="${CYN}" stroke-width="2"/><line x1="10" y1="25" x2="40" y2="25" stroke="${CYN}" stroke-width="2"/><line x1="25" y1="10" x2="25" y2="40" stroke="${CYN}" stroke-width="2"/><circle cx="25" cy="25" r="5" fill="none" stroke="${CYN}" stroke-width="1"/>`, 'ОП-1', 'Спостережний пункт\nбинокль + радіо', [70,70]);

    // Command post
    mk(49.675, 37.285, `<rect x="8" y="8" width="34" height="34" fill="${CYN}33" stroke="${CYN}" stroke-width="2"/><polygon points="25,12 18,22 32,22" fill="${CYN}"/><line x1="25" y1="22" x2="25" y2="38" stroke="${CYN}" stroke-width="2"/><line x1="15" y1="28" x2="35" y2="28" stroke="${CYN}" stroke-width="1"/><line x1="15" y1="32" x2="35" y2="32" stroke="${CYN}" stroke-width="1"/>`, 'КП ВЗВОДУ', 'Командний пункт\nкарта + радіостанція', [80,80]);
    ...
    mk(49.672, 37.315, `<circle cx="30" cy="30" r="12" fill="${BRN}AA" stroke="${BRN}" stroke-width="2"/><line x1="18" y1="18" x2="42" y2="42" stroke="${BRN}" stroke-width="2"/><line x1="42" y1="18" x2="18" y2="42" stroke="${BRN}" stroke-width="2"/><text x="30" y="35" text-anchor="middle" fill="${BRN}" font-size="10" font-weight="bold">П</text>`, 'МІНА-1', 'Піхотна міна\nПФМ-1 "Лепесток"', [60,60]);
    mk(49.673, 37.32, `<circle cx="30" cy="30" r="12" fill="${BRN}AA" stroke="${BRN}" stroke-width="2"/><line x1="18" y1="18" x2="42" y2="42" stroke="${BRN}" stroke-width="2"/><line x1="42" y1="18" x2="18" y2="42" stroke="${BRN}" stroke-width="2"/><text x="30" y="35" text-anchor="middle" fill="${BRN}" font-size="10" font-weight="bold">П</text>`, 'МІНА-2', 'Піхотна міна\nОЗМ-72', [60,60]);
    mk(49.671, 37.325, `<circle cx="30" cy="30" r="12" fill="${BRN}AA" stroke="${BRN}" stroke-width="2"/><line x1="18" y1="18" x2="42" y2="42" stroke="${BRN}" stroke-width="2"/><line x1="42" y1="18" x2="18" y2="42" stroke="${BRN}" stroke-width="2"/><text x="30" y="35" text-anchor="middle" fill="${BRN}" font-size="10" font-weight="bold">П</text>`, 'МІНА-3', 'Піхотна міна\nМОН-50', [60,60]);
    mk(49.674, 37.33, `<circle cx="30" cy="30" r="12" fill="${BRN}AA" stroke="${BRN}" stroke-width="2"/><line x1="18" y1="18" x2="42" y2="42" stroke="${BRN}" stroke-width="2"/><line x1="42" y1="18" x2="18" y2="42" stroke="${BRN}" stroke-width="2"/><text x="30" y="35" text-anchor="middle" fill="${BRN}" font-size="10" font-weight="bold">П</text>`, 'МІНА-4', 'Піхотна міна\nПМН-2', [60,60]);
    mk(49.669, 37.328, `<circle cx="30" cy="30" r="12" fill="${BRN}AA" stroke="${BRN}" stroke-width="2"/><line x1="18" y1="18" x2="42" y2="42" stroke="${BRN}" stroke-width="2"/><line x1="42" y1="18" x2="18" y2="42" stroke="${BRN}" stroke-width="2"/><text x="30" y="35" text-anchor="middle" fill="${BRN}" font-size="10" font-weight="bold">П</text>`, 'МІНА-5', 'Піхотна міна\nПМН-4', [60,60]);

    // Anti-tank mines (TM-62 or similar) - even bigger for visibility
    mk(49.676, 37.318, `<circle cx="30" cy="30" r="15" fill="${RED}AA" stroke="${RED}" stroke-width="3"/><rect x="15" y="15" width="30" height="30" fill="none" stroke="${RED}" stroke-width="2"/><text x="30" y="38" text-anchor="middle" fill="${RED}" font-size="12" font-weight="bold">Т</text>`, 'МІНА-Т1', 'Протитанкова\nТМ-62М', [70,70]);
    mk(49.677, 37.325, `<circle cx="30" cy="30" r="15" fill="${RED}AA" stroke="${RED}" stroke-width="3"/><rect x="15" y="15" width="30" height="30" fill="none" stroke="${RED}" stroke-width="2"/><text x="30" y="38" text-anchor="middle" fill="${RED}" font-size="12" font-weight="bold">Т</text>`, 'МІНА-Т2', 'Протитанкова\nТМ-62', [70,70]);
    mk(49.668, 37.322, `<circle cx="30" cy="30" r="15" fill="${RED}AA" stroke="${RED}" stroke-width="3"/><rect x="15" y="15" width="30" height="30" fill="none" stroke="${RED}" stroke-width="2"/><text x="30" y="38" text-anchor="middle" fill="${RED}" font-size="12" font-weight="bold">Т</text>`, 'МІНА-Т3', 'Протитанкова\nТМ-62П3', [70,70]);
    ...
    zoneLabel(49.672, 37.325, 'МІННЕ ПОЛЕ — НЕБЕЗПЕЧНА ЗОНА!', BRN, 9);

    // Wire obstacles - 2-3 rows, ~100 meters
    ln([[49.675, 37.32], [49.678, 37.33]], BRN, 1, '2 2');
    ln([[49.678, 37.33], [49.681, 37.34]], BRN, 1, '2 2');
    zoneLabel(49.68, 37.335, 'КОЛЮЧИЙ ДРІТ', BRN, 8);

    // Anti-personnel obstacles
    mk(49.673, 37.33, `<polygon points="25,15 15,35 35,35" fill="${BRN}66" stroke="${BRN}" stroke-width="2"/><line x1="20" y1="25" x2="30" y2="25" stroke="${BRN}" stroke-width="1"/><line x1="25" y1="20" x2="25" y2="30" stroke="${BRN}" stroke-width="1"/>`, 'ВОЛЧІ ЯМИ', 'Протипіхотні\nперешкоди', [60,60]);

    // ---- SUPPORTING ELEMENTS ----
    zoneLabel(49.62, 37.05, 'ЕЛЕМЕНТИ ПІДТРИМКИ', GRN, 10);

    // Medical post
    mk(49.655, 37.265, `<rect x="10" y="15" width="30" height="20" fill="${GRN}33" stroke="${GRN}" stroke-width="2"/><line x1="20" y1="10" x2="30" y2="10" stroke="${GRN}" stroke-width="2"/><line x1="25" y1="10" x2="25" y2="35" stroke="${GRN}" stroke-width="2"/><circle cx="25" cy="20" r="3" fill="${GRN}"/>`, 'МЕДПУНКТ', 'Медичний пункт\nаптечки + носилки', [70,70]);

    // Ammunition point
    mk(49.66, 37.255, `<rect x="8" y="8" width="34" height="34" fill="${GRN}33" stroke="${GRN}" stroke-width="2"/><circle cx="25" cy="25" r="8" fill="none" stroke="${GRN}" stroke-width="2"/><line x1="17" y1="17" x2="33" y2="33" stroke="${GRN}" stroke-width="1"/><line x1="33" y1="17" x2="17" y2="33" stroke="${GRN}" stroke-width="1"/><line x1="25" y1="15" x2="25" y2="35" stroke="${GRN}" stroke-width="1"/><line x1="15" y1="25" x2="35" y2="25" stroke="${GRN}" stroke-width="1"/>`, 'БОЄКОМПЛЕКТ', 'Склад БК\nнабої + гранати', [70,70]);

    // ---- DEFENSIVE SECTORS ----
    zoneLabel(49.55, 37.50, 'СЕКТОРИ ОБОРОНИ:', WHT, 11);

    const sectors = [
        { lat: 49.555, lng: 37.25, text: 'ПРАВИЙ ФЛАНГ', desc: 'Сектор №1\nТ-72 + ПТРК\n(позиції парні)', color: BLU },
        { lat: 49.555, lng: 37.35, text: 'ЦЕНТР', desc: 'Сектор №2\nПК + піхота\n(зміни по 2)', color: ORG },
        { lat: 49.555, lng: 37.45, text: 'ЛІВИЙ ФЛАНГ', desc: 'Сектор №3\nБліндаж + стрілецькі\n(пари стрільців)', color: YEL },
    ];
